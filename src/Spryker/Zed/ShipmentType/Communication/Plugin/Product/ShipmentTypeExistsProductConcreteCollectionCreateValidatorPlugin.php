 ...
 */
class ShipmentTypeExistsProductConcreteCollectionCreateValidatorPlugin extends AbstractPlugin implements ProductConcreteCollectionCreateValidatorPluginInterface
{
    /**
     * {@inheritDoc}
